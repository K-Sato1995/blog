...
export const projects: Project[] = [
	...
	{
		name: 'react-toc',
		description: 'React component for creating a table of contents from the given markdown text.',
...

	{
		...
		description: 'ESLint plugin that helps the team(you) stick to English throuout the codebase',
...
export const articles: Project[] = [
...

	{
		...
		description:
			'どんな文字列にも単にstringではなく、それぞれ意味を持たせるにはどうするんだ？と思い調べて書いた。',
		techStack: ['TypeScript'],
