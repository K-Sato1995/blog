...
export const articles: Project[] = [
  {
    ...
    description:
      "Dint't undernd it at first, so looked them up and wrote a post about them",
    techStack: ['Linux'],
  ...
  },
  {
    name: 'My Journey of Go',
    description:
      'Made a series of posts about learning th Go programming language.',
    techStack: ['Go'],
  ...
  },
  {
    ...
    description:
      'Svelteとはそもそも何かの基本部分を簡単に説明できたらな〜と思い書いた。',
    techStack: ['Svelte'],
